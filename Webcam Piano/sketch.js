...
// ********************************
var video;
var prevImg; // Step 1: rename all backImg to prevImg (8 in total)
var diffImg;
var currImg;
var thresholdSlider;
var threshold;
var grid; // Step 3: create a global variable called grid
...
function setup() {
    ...
    // Step 3: connect to the class from Grid.js
...
function draw() {
    ...
    // Step 5: resize to scale it down to a quarter
    currImg.resize(currImg.width/4, currImg.height/4);
    currImg.filter(BLUR, 3) // Step 4: running the blur filter on the currImg 
